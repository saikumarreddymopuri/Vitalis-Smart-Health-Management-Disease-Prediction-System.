...
const Login = () => {
  ...
  // --- 3. GET THE 'setUser' FUNCTION FROM THE CONTEXT ---
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // --- 4. THIS IS THE FIX ---
      // Tell React's memory about the new user *immediately*
      setUser(user);
      // --- END OF FIX ---

      // Now, the navigation will work perfectly
      if (user.role === "Admin") {
  ...
  return (
    // The rest of your beautiful JSX is unchanged
